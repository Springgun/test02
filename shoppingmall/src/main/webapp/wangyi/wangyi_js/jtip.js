...
Tip.prototype = {
	...
	showTipFor : function( dom ){
		var me=$(dom), tip = me.attr("tip"), title = me.attr("title"), inf = me.attr("inf"), target, that=this, tmpl = this.config.wraper, pos, size, autoCreate = !tip, left, maxLeft, orgLeft, fix=0, conf;
		//转移title
		if( title )me.attr("inf", title).removeAttr("title");
		//优先级：tip > title > inf
